...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'listAllUser' => \App\GraphQL\Queries\listAllUser::class,
                'listAllToy' => \App\GraphQL\Queries\listAllToy::class,
                'listActiveToy' => \App\GraphQL\Queries\listActiveToy::class,
                'listDeactiveToy' => \App\GraphQL\Queries\listDeactiveToy::class,
                // ExampleQuery::class,
            ],
            'mutation' => [
                'createToy' => \App\GraphQL\Mutations\createToy::class,
                'deactivateToy' => \App\GraphQL\Mutations\deactivateToy::class,
                'reactivateToy' => \App\GraphQL\Mutations\reactivateToy::class,
                // ExampleMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                \App\GraphQL\Types\toy_type::class,
                \App\GraphQL\Types\user_type::class,
                \App\GraphQL\Types\image_type::class,
